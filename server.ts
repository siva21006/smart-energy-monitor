...
import { initDB, getUserByEmail, getUserById, createUser, updateUser, getUserBills, saveBill, deleteBills, deleteBillById } from './src/lib/db.js';
...
// Do not start the server if running in Vercel serverless environment
